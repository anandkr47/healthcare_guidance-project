...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        ...
        <i class="bi bi-phone"></i> +91 8809568670
      </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Healthcare guidance</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <div class="dropdown">
           ...
           <li><h4 class="dropbtn"> <?= htmlspecialchars($user["name"]) ?></h4></li>
            <div class="dropdown-content">
                <a href="fetchprofile.php">Profile</a>
                <li><a class="nav-link scrollto" href="fetch-appointment.php">Appointments</a></li>
   ...
   <section id="counts" class="counts">
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <form action="process-appointment.php" method="post" id="appointment" novalidate>
          <div class="row">
    ...
    <section id="contact" class="contact">
      ...
      <!--Google map-->
      <div class="mapouter"><div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3740.750239068914!2d85.81117641411092!3d20.351934115915782!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a19092289cbfcef%3A0x26d133989a910e1a!2sKalinga%20Institute%20of%20Medical%20Sciences%20-%20KIMS%20Hospital%2C%20Bhubaneswar!5e0!3m2!1sen!2sin!4v1667962837110!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe><a href="https://www.fnfgo.com/">FNF Mods</a></div><style>.mapouter{position:relative;text-align:right;width:100%;height:363px;}.gmap_canvas {overflow:hidden;background:none!important;width:100%;height:363px;}.gmap_iframe {height:363px!important;}</style></div>
      ...
      <div class="container">
        <div class="row mt-5">
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>KIMS Hospital Road, 751024</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>prcare@gmail.com</p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
                ...
                <form action="https://formsubmit.co/b57e1ce8077272f845d4a2b3770e2c6c" method="POST" >
                  <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>PR-CARE</h3>
              <p>
                KIMS Hospital Road<br>
                751024 Bhubneshwar,Odisha,India <br><br>
                <strong>Phone:</strong> +1 5589 55488 55<br>
                <strong>Email:</strong> prcare@gmail.com<br>
              </p>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <form accept="" role="form" class="php-email-form">
          ...
          <a href="signup.html" class="appointment-btn scrollto"><span class="d-none d-md-inline">Make an</span> Appointment</a>
        </div>
        </form>
